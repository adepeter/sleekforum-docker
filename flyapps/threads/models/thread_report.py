...
class ThreadReport(models.Model):
    ...
    reported_by = models.ManyToManyField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,
                                         related_name='thread_reports')
    rules_broken = models.ManyToManyField(ThreadRule, on_delete=models.CASCADE, related_name='thread_reports')
